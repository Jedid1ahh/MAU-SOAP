...
|------|-----|--------------|
| Primary | `#0B2F55` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#1457AD` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#1D6FD8` | `--color-accent` |
| On Accent/CTA | `#FFFFFF` | `--color-on-accent` |
| Background | `#F5F7FB` | `--color-background` |
| Foreground | `#152238` | `--color-foreground` |
| Card | `#FFFFFF` | `--color-card` |
| Card Foreground | `#152238` | `--color-card-foreground` |
| Muted | `#E8F0F8` | `--color-muted` |
| Muted Foreground | `#59687D` | `--color-muted-foreground` |
| Border | `#DCE4EE` | `--color-border` |
| Destructive | `#B4232F` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#2B7DE0` | `--color-ring` |

**Color Notes:** Institutional navy, accessible trust blue, and restrained semantic status colors.

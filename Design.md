...
## Mission
Create implementation-ready, token-driven UI guidance for Live Demo that is optimized for consistency, accessibility, and fast delivery across content site.

## Brand
- Product/brand: Live Demo
- URL: https://htmlcodex.com/demo/?item=2151
...
- Color palette: `color.text.primary=#000000`, `color.surface.base=#ffffff`
